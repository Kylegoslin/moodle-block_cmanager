...
if(isset($_GET['new'])){
	if(required_param('new', PARAM_INT) == 1){
	   ...
	   $newrec->formid = $DB->get_field('cmanager_config', 'value', array('varname'=>'current_active_form_id'));
	  
	   $currentSess = $DB->insert_record('cmanager_records', $newrec, true);
...
class courserequest_form extends moodleform {
    ...
    function definition() {
        ...
        $currentRecord =  $DB->get_record('cmanager_records', array('id'=>$currentSess), '*', IGNORE_MULTIPLE);
	...
	$field1title = $DB->get_field('cmanager_config', 'value', array('varname'=>'page1_fieldname1'), IGNORE_MULTIPLE);
	$field1desc = $DB->get_field('cmanager_config', 'value', array('varname'=>'page1_fielddesc1'), IGNORE_MULTIPLE);
	$field2title = $DB->get_field('cmanager_config', 'value', array('varname'=>'page1_fieldname2'), IGNORE_MULTIPLE);
	$field2desc = $DB->get_field('cmanager_config', 'value', array('varname'=>'page1_fielddesc2'), IGNORE_MULTIPLE);
	$field3desc = $DB->get_field('cmanager_config', 'value', array('varname'=>'page1_fielddesc3'), IGNORE_MULTIPLE);
	$field4title = $DB->get_field('cmanager_config', 'value', array('varname'=>'page1_fieldname4'), IGNORE_MULTIPLE);
	$field4desc = $DB->get_field('cmanager_config', 'value', array('varname'=>'page1_fielddesc4'), IGNORE_MULTIPLE);
 	//get field 3 status
	$field3status = $DB->get_field('cmanager_config', 'value', array('varname'=>'page1_field3status'), IGNORE_MULTIPLE);
