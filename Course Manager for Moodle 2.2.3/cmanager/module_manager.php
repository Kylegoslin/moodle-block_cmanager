...
class courserequest_form extends moodleform {
	...
	//$pendingList = $DB->get_recordset_select('cmanager_records', $select=$selectQuery, $sort='', $fields='*', $limitfrom='', $limitnum='');
	
	$pendingList = $DB->get_records('cmanager_records',array('createdbyid' => "$uid AND" , 'status' => 'PENDING'), 'id DESC');
   ...
   foreach($pendingList as $rec){
		...
		$page1_fieldname4 = $DB->get_field_select('cmanager_config', 'value', "varname = 'page1_fieldname4'");
