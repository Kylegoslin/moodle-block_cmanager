...
if(isset($_GET['t']) && isset($_GET['id'])){
	...
	if(required_param('t', PARAM_TEXT) == 'd'){
		...
		$DB->delete_records_select('cmanager_config', $deleteQuery);
...
if(isset($_POST['naming']) && isset($_POST['key']) && isset($_POST['course_date']) &&isset($_POST['defaultmail']) &&isset($_POST['snaming'])){
		 ...
		 //update autoKey
	 	 $newrec = new stdClass();
		 $rowId = $DB->get_field_select('cmanager_config', 'id', "varname = 'autoKey'");	 
		 $newrec->id = $rowId;	 
		...
		//update naming
	 	 $newrec = new stdClass();
		 $rowId = $DB->get_field_select('cmanager_config', 'id', "varname = 'naming'");	 
		 $newrec->id = $rowId;	 
		...
		//update snaming
	 	 $newrec = new stdClass();
		 $rowId = $DB->get_field_select('cmanager_config', 'id', "varname = 'snaming'");	 
		 $newrec->id = $rowId;	 
		...
		$newrec = new stdClass();
		$rowId = $DB->get_field_select('cmanager_config', 'id', "varname = 'startdate'");	 
		$newrec->id = $rowId;	 
		...
		$newrec = new stdClass();
		$rowId = $DB->get_field_select('cmanager_config', 'id', "varname = 'emailSender'");	 
		$newrec->id = $rowId;	 
...
class courserequest_form extends moodleform {
    ...
    function definition() {
		...
		// Email text box
		$approvedTextRecord = $DB->get_record('cmanager_config', array('varname'=>'approved_text'));
		...
		if($approvedTextRecord != null){
			...
			// Approved user email
			$approved_user_email =  $DB->get_record('cmanager_config', array('varname'=>'approveduseremail'));
			...
			$approved_admin_email =  $DB->get_record('cmanager_config', array('varname'=>'approvedadminemail'));
			...
			$request_new_module_user =  $DB->get_record('cmanager_config', array('varname'=>'requestnewmoduleuser'));
			...
			$request_new_module_admin =  $DB->get_record('cmanager_config', array('varname'=>'requestnewmoduleadmin'));
		    ...
		    // Comment email admin
			$comment_email_admin =  $DB->get_record('cmanager_config', array('varname'=>'commentemailadmin'));
		    ...
		    // Comment email user
			$comment_email_user =  $DB->get_record('cmanager_config', array('varname'=>'commentemailuser'));
			...
			$module_request_denied_admin =  $DB->get_record('cmanager_config', array('varname'=>'modulerequestdeniedadmin'));
			...
			// Request denied user
			$module_request_denied_user =  $DB->get_record('cmanager_config', array('varname'=>'modulerequestdenieduser'));
			...
			// Handover current
			$handover_current =  $DB->get_record('cmanager_config', array('varname'=>'handovercurrent'));
			...
			//Handover user
			$handover_user =  $DB->get_record('cmanager_config', array('varname'=>'handoveruser'));
			$handover_user_value = '';
			...
			// Handover admin
			$handover_admin =  $DB->get_record('cmanager_config', array('varname'=>'handoveradmin'));
			...
			$autoKey = $DB->get_field_select('cmanager_config', 'value', "varname = 'autoKey'");	
			$naming = $DB->get_field_select('cmanager_config', 'value', "varname = 'naming'");
			$snaming = $DB->get_field_select('cmanager_config', 'value', "varname = 'snaming'");
			$emailSender = $DB->get_field_select('cmanager_config', 'value', "varname = 'emailSender'");
...
';
			...
			$timestamp_startdate = $DB->get_field_select('cmanager_config', 'value', "varname = 'startdate'");	
			//convert to date
