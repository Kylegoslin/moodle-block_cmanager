...
$configHasRun = $DB->get_field('cmanager_config', 'value', array('varname'=>'confighasrun'));
...
$newrec->value = '1';
$DB->insert_record('cmanager_config', $newrec, false);
...
$activeFormId = $DB->get_field('cmanager_config', 'id', array('varname'=>'page2form'));
...
$DB->insert_record('cmanager_formfields', $newrec, false);
