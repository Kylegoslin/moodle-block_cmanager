...
function cancelConfirm(i,langString) {
	...
	if (answer){
		...
		window.location = "block_cmanager_config.php?t=d&&id=" + i;
	}
	else{
...
$PAGE->set_url('/blocks/cmanager/block_cmanager_config.php');
...
if(isset($_GET['t']) && isset($_GET['id'])){
	...
	if(required_param('t', PARAM_TEXT) == 'd'){
	    ...
	    echo "<script>window.location='block_cmanager_config.php';</script>";
	}
}
...
class courserequest_form extends moodleform {
    ...
    function definition() {
	    ...
	    // Back Button
		$mform->addElement('html', '<p></p>&nbsp;&nbsp;&nbsp;<a href="block_cmanager_confighome.php">&lt ' . get_string('back','block_cmanager') . '</a><p></p>');
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	get_string('namingConvetion','block_cmanager').'
		...
		<form action="block_cmanager_config.php" method="post">
			<select name="naming">';
