...
if(isset($_GET['t']) && isset($_GET['del'])){
    ...
    if($_GET['t'] == 'drop'){
         ...
         // $delId = $_GET['del'];
        //  $DB->delete_records('block_cmanager_formfields', "id = $delId"); 
		  
		  // Delete the data records
    	  //$DB->delete_records('block_cmanager_form_data', "fieldid = $delId"); 
		  
		  /*
		  // Reorder the rest of the fields
		  
		 $selectQuery = "";
		 // $positionItems = $DB->get_recordset_select('block_cmanager_formfields', $select=$selectQuery, $sort='position ASC', $fields='*', $limitfrom='', $limitnum='');
			$positionItems = $DB->get_recordset_select('block_cmanager_formfields', $select=$selectQuery);
...
if(isset($_GET['del'])){
	...
	$selectQuery = "SELECT * FROM mdl_block_cmanager_formfields WHERE formid = $formid order by id ASC";
