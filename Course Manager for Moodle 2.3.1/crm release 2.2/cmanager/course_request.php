...
class courserequest_form extends moodleform {
    ...
    //$mform->addElement('html', '<p></p><br>' . $field1desc . '</div><p></p>');
    ...
    //$mform->addElement('html', '<p></p><br><div style="left:360px; top:0; position:relative; font-size: 0.8em; color: #888;">' . $field2desc. '</div><p></p>');
  ...
  //  $mform->addElement('html', '<p></p>' . $field4desc. '</div><p></p><br>');
