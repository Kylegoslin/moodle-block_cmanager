...
global $DB;
$emailSender = $DB->get_field('block_cmanager_config', 'value', array("varname"=>'emailSender'), IGNORE_MULTIPLE);
...
function sendEmailToAddress($to, $subject, $text){
	...
	email_to_user($emailingUserObject, $from, $subject, $text, $messagehtml='', $attachment='', 
				       $attachname='', $usetrueaddress=true, $replyto='', $replytoname='', $wordwrapwidth=79);
