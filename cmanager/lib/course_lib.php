...
function block_cmanager_create_new_course_by_record_id($mid, $sendMail) {
    ...
    $new_course->format = $courseconfig->format;
    ...
    $new_course->newsitems 			= $courseconfig->newsitems;
    $new_course->showgrades 		= $courseconfig->showgrades;
    $new_course->showreports 		= $courseconfig->showreports;
    $new_course->maxbytes 			= $courseconfig->maxbytes;

    //Formatting
    $new_course->numsections 		= $courseconfig->numsections;
    $new_course->hiddensections 	= $courseconfig->hiddensections;

    // Groups
    $new_course->groupmode 			= $courseconfig->groupmode;
    $new_course->groupmodeforce 	= $courseconfig->groupmodeforce;

    // Visible
    $new_course->visible 			= $courseconfig->visible;
    $new_course->lang 				= $courseconfig->lang;

    // Completion
    $new_course->enablecompletion	= $courseconfig->enablecompletion;
